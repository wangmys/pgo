...
<div class="col-lg-6 col-sm-6 col-xs-12" id="one">
    <div class="widget">
        ...
        <div class="widget-body">
            <div>
                <form class="form-horizontal form-bordered" role="form" method="post" enctype="multipart/form-data" action="/admin/links/<?php echo e($data->id); ?>">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="url" id="url" value="<?php echo e($data->url); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="logo" class="col-sm-2 control-label no-padding-right">链接logo</label>
                        <div class="col-sm-10">
                            <img src="<?php echo e($data->logo); ?>" alt="" width="30%">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="desc" name="desc" value="<?php echo e($data->desc); ?>">
                        </div>
                    </div>
                     <div class="form-group">
						...
						<div class="col-sm-10">
	                        <label class="col-sm-offset-1">
	                            <input type="radio" class="colored-blue" name="type" value="1" <?php if($data->type=='1'): ?> checked="checked" <?php endif; ?>>
	                            <span class="text"> 文字</span>
	                        </label>
	                        <label style="margin-left: 20px;">
	                            <input type="radio" class="colored-danger" name="type" value="0" <?php if($data->type=='0'): ?> checked="checked" <?php endif; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="col-sm-offset-1">
                                <input type="radio" class="colored-blue" name="status" checked="checked" value="1" <?php if($data->status=='1'): ?> checked="checked" <?php endif; ?>>
                                <span class="text">显示</span>
                            </label>
                            <label style="margin-left: 20px;">
                                <input type="radio" class="colored-danger" name="status" value="0" <?php if($data->status=='0'): ?> checked="checked" <?php endif; ?>>
