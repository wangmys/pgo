...
function hrefLink(e) {
 ...
 <body> 
  ...
  <!-- 引入项目css资源文件 --> 
  <link rel="stylesheet" type="text/css" href="<?php echo e(_HOME_); ?>/css/safepc.css" /> 
  <link rel="stylesheet" type="text/css" href="<?php echo e(_HOME_); ?>/css/head.css?v=201601280042" /> 
  <!-- 此处引入公用头部 --> 
  <!-- 此处引入公用头部 --> 
      ...
      <div class="main-cont"> 
       ...
       <div class="reg-main mt0">
        ...
        <div class="reg-code uname-code"> 
         ...
         <div class="code-num"> 
          <!-- <img id="imgSrc" src="" />  -->
           <img src="<?php echo e(captcha_src()); ?>"  onclick="this.src+='?c='+Math.random()" class="code" style="height: 75%;width: 55%" />
