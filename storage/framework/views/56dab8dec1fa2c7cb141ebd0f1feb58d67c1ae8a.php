  ...
  <div class="ng-toolbar"> 
   <div class="ng-toolbar-con wrapper"> 
    <div class="ng-toolbar-left"> 
     <a href="<?php echo e(url('/')); ?>" class="ng-bar-node ng-bar-node-backhome" id="ng-bar-node-backhome" name="public0_none_dbgjt_fhyisy01"> <i class="ng-iconfont ng-backhome"></i><span>返回易购首页</span> <i class="ng-line ng-iconfont ml10"></i> </a> 
    ...
    <div class="ng-toolbar-right"> 
     ...
     <?php if(empty(session('UserInfo'))): ?> 
       <div class="ng-bar-node reg-bar-node" id="reg-bar-node"> 
        <a href="<?php echo e(url('login')); ?>" name="public0_none_dbgjt_login0800" rel="nofollow" class="login">登录</a> 
        <a href="<?php echo e(url('register')); ?>" target="_blank" class="login reg-bbb" rel="nofollow" name="public0_none_dbgjt_register09">注册</a> 
       </div>
     <?php else: ?>
       <div class="ng-bar-node reg-bar-node" id="reg-bar-node"> 
        <a href="<?php echo e(url('/userinfo')); ?>" name="public0_none_dbgjt_login0800" rel="nofollow" class="login"><?php echo e(session('UserInfo')['uname']); ?></a> 
        <a href="<?php echo e(url('logout')); ?>" target="_self" class="login reg-bbb" rel="nofollow" name="public0_none_dbgjt_register09">退出</a> 
       </div>
     <?php endif; ?>  
     <script type="text/javascript">
function d(b) {
...
regBarNode.style.display = "block";
     ...
     <div class="ng-bar-node-box mysuning-handle"> 
      <a href="<?php echo e(url('/userinfo')); ?>" rel="nofollow" name="public0_none_dbgjt_wdyg05" class="ng-bar-node ng-bar-node-fix touch-href ng-bar-node-pr5"><span>我的易购</span><em class="ng-iconfont down"></em></a> 
