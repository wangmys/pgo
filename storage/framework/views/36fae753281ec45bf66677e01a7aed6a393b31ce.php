     ...
     <ul class="sort-list"> 
      <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
        <li id="<?php echo e($v->id); ?>" class="cate_one"> 
            ...
            <a target="_blank" name="public0_none_ml1_zc010101" href="child.html?"><?php echo e($v->cate_name); ?></a>
        </li> 
     ...
     <div class="ng-sort-detail"> 
       <a name="public0_none_ml_gban" href="javascript:void(0);" class="ng-close-sort" target="_self"><em class="ng-iconfont"></em></a>
        <div style="height: 100%;width: 100%;padding: 25px 35px 25px">
            <?php $__currentLoopData = model('Cate')->twocate(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
             <a href="https://shouji.suning.com/phone2018.html" target="_blank" name="public0_sortListv6_968427813_word01" title="手机频道" class="cate_two" pid="<?php echo e($v->pid); ?>" style="display: none">
