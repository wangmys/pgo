...
<script type="text/javascript">
    $('button[type=submit]').click(function(){
        ...
        $.ajax({
            ...
            type:'PUT',
            url:'/admin/cate/'+$('input[name=id]').val(),
            data:{'cate_name':cate_name,'show':show,'keyword':keyword,'descripton':descripton},
            success:function(data){
                if(data=='1'){
                    layer.msg('修改成功!', {icon: 1,offset:'250px',time:1000});
                    setTimeout("location.href='/admin/cate'",1200);
                }else{
                    layer.msg('修改失败!', {icon: 2,offset:'250px',time:1000});
                    setTimeout("location.href='/admin/cate'",1200);
                }
                console.log(data);
            },
