...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head> 
  ...
  <!-- 页尾使用的css文件 --> 
  <link type="text/css" rel="stylesheet" href="<?php echo e(_HOME_); ?>/css/login.css" /> 
  <script type="text/javascript" src="<?php echo e(asset( _PLUS_ .'/layer/layer.js')); ?>"></script>
  <script type="text/javascript" src="<?php echo e(_HOME_); ?>/js/jquery-1.7.1.js"></script> 
  <script type="text/javascript" src="<?php echo e(_HOME_); ?>/js/login.js"></script>
  <style>
  	.uname-error{
  		padding-left: 20px;
  		margin: 0px;
 ...
 <body>
  ...
  <div class="login-main"> 
   ...
   <div class="login-logo"> 
		    <a href="<?php echo e(url('/')); ?>" title="苏宁易购"><img alt="苏宁易购" src="<?php echo e(_HOME_); ?>/images/snlogo.png" /></a>
   </div> 
   <!--顶部logo区域 ]]--> 
   <!--登录区域 表单 [[--> 
   <div class="login-form"> 
    ...
    <div class="login-code" id="imageVerifyArea"> 
     ...
     <div class="code-num" style="height: 80%;margin-top:10px;padding: 0px"> 
      <img src="<?php echo e(captcha_src()); ?>"  onclick="this.src+='?c='+Math.random()" style="width:100%;height:100%" class="code" /> 
     </div> 
     <div class="code-link">
       看不清 
    ...
    <div class="links-text"> 
     ...
     <a href="<?php echo e(url('/forget')); ?>" class="link-left" id="Logon_index_denglu001" name="Logon_index_denglu001">忘记密码</a> 
     <span class="link-left mid-line"></span> 
     <a href="<?php echo e(url('/register')); ?>" class="link-left" name="Logon_index_denglu003" id="Logon_index_denglu003">免费注册</a> 
