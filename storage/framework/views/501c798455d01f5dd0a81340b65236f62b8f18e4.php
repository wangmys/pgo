        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal"  id="art_form" role="form" action="<?php echo e(url('admin/login')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                            	<img src="<?php echo e(ADMIN_IMG.'/'.$rs->img); ?>" id="imgss">
