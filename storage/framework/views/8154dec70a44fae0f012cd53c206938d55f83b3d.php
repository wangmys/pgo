...
<script type="text/javascript">
    $('button[type=submit]').click(function(){
        ...
        $.ajax({
            ...
            type:'post',
            url:'/admin/cate',
            data:{'pid':pid,'cate_name':cate_name,'show':show,'keyword':keyword,'descripton':descripton},
            
            success:function(data){
                if(data=='1'){
                    layer.msg('添加成功!', {icon: 1,offset:'250px',time:1000});
                    setTimeout("location.href='/admin/cate'",1200);
                }else{
                    layer.msg('添加失败!', {icon: 2,offset:'250px',time:1000});
                    setTimeout("location.href='/admin/cate'",1200);
                }
                // console.log(data);
            },
