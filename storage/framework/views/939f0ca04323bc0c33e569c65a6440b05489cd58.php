...
<?php $__env->startSection('title2', '添加品牌'); ?>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo e(url('admin/goods_brand')); ?>" method="post" enctype="multipart/form-data">
