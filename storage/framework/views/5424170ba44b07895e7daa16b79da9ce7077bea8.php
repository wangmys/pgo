 ...
 <div class="first-screen"> 
   <div class="banner"> 
    ...
    <div class="banner-pic"> 
      <?php $__currentLoopData = $ads[0]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
        <ul>
          <li style="background:#eeeeee;">
              <a expotype="2" expo="index_lbgg0101:365天放心购" href="http://sale.suning.com/zh/315baofa/index.html" title="365天放心购" target="_blank" name="index2_none_lbgg_010<?php echo e($k); ?>">
                <img data-src="<?php echo e(u(_AD_).$v); ?>" alt="365天放心购" class="ad" />
              </a>
          </li>
         </ul> 
    ...
    <ul class="banner-ctrl">
      <?php $__currentLoopData = $ads[1]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
          <li class="ctrl0<?php echo e($k); ?>"> <span class="bg"></span> 
            <div class="ctrl-dot"> 
             <i></i> 
            </div> 
            <div class="title-item"> 
             ...
             <div class="title-list"> 
              <p><i></i><a href="http://sale.suning.com/zh/315baofa/index.html" target="_blank" name="index2_none_lbgg_0<?php echo e($k); ?>01"><?php echo e($v['ad_name']); ?></a></p>  
             </div> 
            </div> <h4><?php echo e($v['title']); ?></h4> 
          </li>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </ul>
   </div> 
    ...
    <div class="box-all"> 
     ...
     <div class="notice"> 
      ...
      <ul class="list">
       ...
       <li ><a name="index2_none_gg_01" href="<?php echo e(url('notice_content/'.$v->id)); ?>" rel="nofollow" target="_blank"><i>【公告】</i><em><?php echo e($v->title); ?></em></a></li>
       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </ul>
     </div> 
     <div class="title"> 
...
loadBanner();
  ...
  <div class="new-user"> 
   <div class="new-pic"> 
    <a name="index2_none_tk_xr" href="http://sale.suning.com/zh/xrdlb/index.html" target="_blank"> <img src="<?php echo e(asset(_HOME_ . '/images')); ?>/145639401885988055.png" alt="" data-src="<?php echo e(asset(_HOME_ . '/images')); ?>/145639401885988055.png" /> </a> 
   </div> 
   <i class="close"></i> 
  </div> 
  ...
  <div class="activityEnter"> 
   <ul> 
    ...
    <li> <a name="index2_none_huichang_04" target="_blank" href="<?php echo e($v->brand_url); ?>" > <img lazy-src="<?php echo e(_UPLOADS_.'/goods_brand'.'/'.$v->brand_logo); ?>"/> </a> </li>
