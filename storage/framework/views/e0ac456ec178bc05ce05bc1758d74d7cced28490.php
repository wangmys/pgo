 ...
 <div class="wrapper proinfo" style="margin-top: 20px">
  <div class="proinfo-container clearfix">
    ...
    <div class="imgzoom" id="imgZoom">
     ...
     <div class="imgzoom-main"  id="small">
      <a href="javascript:void(0);" class="view-img" >
          <img id="smallImg" src="<?php echo e(url(asset(GOODS_IMG.'/'.$goods->goods_img))); ?>" alt="<?php echo e($goods->goods_name); ?>" width="100%" />
      </a>
       ...
       <ul id="uls" style="left: 0px;">
        ...
        <li class="current">
            <a href="javascript:void(0);" name="item_122639559_sppic_xiaop01">
                <img src="<?php echo e(url(asset(GOODS_IMG.'/'.$v->img))); ?>"  alt="香奈儿 /CHANEL 粉色邂逅柔情女士持久淡香水 35ML 法国进口" />
            </a>
        </li>
    ...
    <div class="imgzoom-memo">
        <label>商品编码</label>:
        <em id="partNumberLable"><?php echo e($goods->goods_num); ?></em>
        <div class="share">
    ...
    <h1 id="itemDisplayName"><?php echo e($goods->goods_name); ?></h1>
    ...
    <div class="proinfo" id="big" style="width: 400px;height: 400px;position: absolute;left:400px;top:0px;display: none;overflow: hidden;">
        <img id="bigImg" src="<?php echo e(url(asset(GOODS_IMG.'/'.$goods->goods_img))); ?>" style="position: absolute;">
    </div>
    ...
    <div style="" class="proinfo-focus clearfix proinfo-focus-qrcode proinfo-focus-qrcode-short" id="existPrice">
     ...
     <dl class="price-promo" id="promotionPriceBox" style="display: block;">
      ...
      <dd id="proPriceBox">
       <span class="mainprice" id="promotionPrice"><i>&yen;</i><?php echo e($goods->shop_price); ?></span>
    ...
    <div style="margin-top:5px;" class="proinfo-num" id="buycount">
        <dl  class="proinfo-buytype proattr-radio">
            ...
            <dt style="padding-left:1px;">
                <?php echo e($goods->goods_weight); ?><?php if($goods->weight_unit == 0): ?> g <?php elseif($goods->weight_unit == 1): ?> Kg <?php endif; ?>
            </dt>
        </dl>
    </div>
        ...
        <?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="margin-top:1px;">
                <dl id="versionItemList" class="proinfo-buytype proattr-radio">
                    <dt> <span class=""> <?php echo e($v->attr_name); ?> </span> </dt>
                    <dd>
                        <ul>
                            <?php $array = explode(',',$v->attr_values);?>
                            <?php $__currentLoopData = $array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kk=>$vv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li onclick="dian(this)">
                                    <a  href="javascript:void(0);"  ><?php echo e($vv); ?></a>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
   ...
   <dl style="margin-top: 1px;" class="proinfo-num" id="buycount">
       ...
       <dt >
           库存:(<sanp id="goods_kc"><?php echo e($goods->goods_kc); ?></sanp>)件
       </dt>
     ...
     <div class="procon-side">
         ...
         <div data-type="jsonp" id="hotRank" class="lazy-ajax area mt10">
             ...
             <ul class="toppro-list" id="J-topPro-1" style="display:block;">
                <?php $__currentLoopData = $goods_brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <li>
                     <a name="" target="_blank" href="<?php echo e(url('goodslist/'.$v->id)); ?>" >
                         <img alt="" src="<?php echo e(url(asset(GOODS_IMG.'/'.$v->goods_img))); ?>">
                     </a>
                     <p class="title">
                         <a id="" name="" target="_blank" href="<?php echo e(url('goodslist/'.$v->id)); ?>">
                            <?php echo e($v->goods_name); ?>

                         </a>
                     </p>
                     <p class="price"><i>¥</i><?php echo e($v->shop_price); ?></p>
                     <span class="num highlight"><?php echo e($k+1); ?></span>
                 </li>
                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
             </ul>
         </div>
        ...
        <ul class="toppro-list" id="J-topPro-1" style="display:block;">
            <?php $__currentLoopData = $goods_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <li>
               <a  target="_blank" href="<?php echo e(url('goodslist/'.$v->id)); ?>" title="">
                   <img alt="" src="<?php echo e(url(asset(GOODS_IMG.'/'.$v->goods_img))); ?>">
               </a>
               <p class="title">
                   <a id=""  target="_blank" href="<?php echo e(url('goodslist/'.$v->id)); ?>">
                       <?php echo e($v->goods_name); ?>
