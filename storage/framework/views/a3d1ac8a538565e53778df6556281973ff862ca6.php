            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    ...
                    <div id="horizontal-form">
                        <form class="form-horizontal" role="form" action="<?php echo e(url('/admin/goods_type')); ?>" method="post" >
                            <?php echo e(csrf_field()); ?>

                            <div class="form-group">
                                <label for="username" class="col-sm-2 control-label no-padding-right">商品类型名称</label>
                                <div class="col-sm-4">
                                    <input class="form-control" id="username" placeholder="请填写商品类型的名称" name="type_name" required="" type="text">
                                </div>
