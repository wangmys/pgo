...
"99999":{"title":"365天放心购","name":"index2_none_dtgg_cs0100","bgColor":"#e21325","link":"http://sale.suning.com/zh/315baofa/index.html","picNarrow":"<?php echo e(asset(_HOME_ . '/images')); ?>/145770027871038675.jpg","picWide":"<?php echo e(asset(_HOME_ . '/images')); ?>/145770028244971915.jpg"}
  ...
  <div class="ng-header"> 
   ...
   <div class="ng-header-con"> 
    ...
    <div class="ng-header-box"> 
     ...
     <img src="<?php echo e(asset(_HOME_ . '/images')); ?>/ShoppingArea/Common/blank.gif" src3="<?php echo e(asset(_HOME_ . '/images')); ?>/slogn.png" class="slogn" /> 
    </div> 
    <div class="ng-search"> 
     <!-- PRFLS SEARCH --> 
     <div class="g-search"> 
    ...
    <div class="index-head-active"> 
     <a name="public0_none_dbgjt_ssycgg" href="http://sale.suning.com/syb/yinliuye0512/index.html" target="_blank" title="客户端新人95元券"><img src="<?php echo e(asset(_HOME_ . '/images')); ?>/145762207799884886.jpg" alt="客户端新人95元券" /></a> 
    </div> 
   </div> 
  </div> 
  <!--header ]]--> 
  ...
  <div class="ng-nav-bar"> 
   <div class="ng-sort ng-sort-index"> 
    ...
    <!-- <a name="public0_none_ml_qbspfl" class="ng-all-hook" href="http://www.suning.com/emall/pgv_10052_10051_1_.html" target="_blank"> <em class="ng-iconfont"></em><span>全部商品分类</span><b></b> </a>  -->
