...
<html>
 <head> 
  ...
  <link rel="stylesheet" href="<?php echo e(_HOME_); ?>/css/common.css" /> 
  <link rel="stylesheet" href="<?php echo e(_HOME_); ?>/css/search.css" /> 
  <link rel="stylesheet" href="<?php echo e(_HOME_); ?>/css/sn-sidebar.css" /> 
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo e(_HOME_); ?>/css/reset.min.css?v=2016030101" /> 
  <link rel="stylesheet" type="text/css" href="<?php echo e(_HOME_); ?>/css/ms-style.min.css?v=2016030101" /> 
  <link rel="stylesheet" type="text/css" href="<?php echo e(_HOME_); ?>/css/personal_member.min.css?v=2016030101" /> 
  <link rel="stylesheet" type="text/css" href="<?php echo e(_HOME_); ?>/css/calendar.min.css?v=2016030101" /> 
  <link rel="stylesheet" type="text/css" href="<?php echo e(_HOME_); ?>/css/Snaddress.min.css?v=2016030101" /> 
  <link rel="stylesheet" type="text/css" href="<?php echo e(_HOME_); ?>/css/imgareaselect-default.min.css?v=2016030101" /> 
 </head> 
  ...
  <header class="ms-header ms-header-inner ms-head-position"> 
   <article class="ms-header-menu"> 
    ...
    <div class="header-menu"> 
     <div class="ms-logo"> 
      <a name="Myyigou_index_none_daohangLogo" href="<?php echo e(url('/userinfo')); ?>" class="ms-head-logo"></a> 
     </div> 
     <nav class="ms-nav"> 
      <ul> 
       <li class=""><a name="Myyigou_index_none_daohang1001" data-url="" href="<?php echo e(url('/')); ?>">首页</a><i class="nav-arrow"></i></li> 
       <li class="nav-manage selected"> <a name="Myyigou_index_none_daohang1003" data-url="" href="http://www.suning.com">账户管理<em></em></a><i class="nav-arrow"></i> 
        <div class="list-nav-manage hide"> 
         ...
         <p><a name="Myyigou_index_none_daohang10031" data-url="" href="<?php echo e(url('/userinfo')); ?>">个人信息</a></p> 
...
.news-icon{
    ...
    padding-right: 24px;
       ...
       <dl style="" class="side-menu-tree"> 
        ...
        <dd> 
         <a href="<?php echo e(url('/userinfo')); ?>" data-url="personMyInfoMenuFlag" name="Myyigou_index_none_daohang50011" id="50011" style="color:#f70"><span>&middot;</span>个人信息</a> 
        </dd> 
        <dd> 
       ...
       <div class="user-profile-wrap"> 
        ...
        <form action="" method="post" enctype="multipart/form-data" id="art_form">
        	<?php echo e(csrf_field()); ?>
         	...
         	<img src="<?php echo e(session('uface')); ?>" height="150" width="150" style="cursor: pointer;" onclick="pullPic()" id="img1" title="点击修改头像" />
       ...
       <div class="profile-info"> 
        <div class="control-group clearfix "> 
         ...
         <div class="controls lh26"> 
          <input id="userName" name="userName" maxlength="25" type="text" class="text" value="<?php echo e(session('UserInfo')['uemail']); ?>"/> 
         </div> 
         <!-- 报错位 [[ --> 
      ...
      <div class="form-list tab-switch personal-wrap-show"> 
       ...
       <form> 
        <div class="control-group clearfix"> 
         ...
         <div class="controls"> 
          <input name="uname" type="text" class="uname" maxlength="20" value="<?php echo e(session('UserInfo')['uname']); ?>" /> 
         </div> 
         <!-- 报错位 [[ --> 
        ...
        <div class="control-group clearfix"> 
         ...
         <div id="gender" class="controls"> 
          <label class="sex-label"> 
              <input type="radio" name="sex" value="m" <?php if(session('UserInfo')['sex']=='m'): ?> checked <?php endif; ?> />
              <span>男</span> 
          </label> 
          <label class="sex-label"> 
              <input type="radio" name="sex" value="w" <?php if(session('UserInfo')['sex']=='w'): ?> checked <?php endif; ?>/> 
              <span>女</span> 
          </label> 
          <label class="sex-label">
             <input type="radio" name="sex" value="o"  <?php if(session('UserInfo')['sex']=='o'): ?> checked <?php endif; ?>/>
             <span>保密</span> </label> 
         </div> 
        </div> 
        <div class="control-group clearfix"> 
         ...
         <div class="controls lh26"> 
          <span name="pone" class="pone">
          	 	<?php echo e(session('UserInfo')['pone']); ?> 
          </span> 
