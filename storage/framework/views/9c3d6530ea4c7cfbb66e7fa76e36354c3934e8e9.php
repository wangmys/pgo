...
<?php $__env->startSection('title2', '修改轮播图'); ?>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="/admin/ad/<?php echo e($data->id); ?>" method="post" enctype="multipart/form-data">
                       ...
                       <?php echo e(method_field('PUT')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo e($data->ad_name); ?>" name="ad_name" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo e($data->title); ?>" name="title" type="text" required="">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo e($data->url); ?>" name="url" type="text" required="">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            <img src="<?php echo e(u(_AD_).$data->src); ?>" alt="" style="width:20%;margin-left: 18%;cursor: pointer;" align="left" name="oldSrc" onclick="$('#file').click()">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo e($data->sort); ?>" name="sort" type="text" required="">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
